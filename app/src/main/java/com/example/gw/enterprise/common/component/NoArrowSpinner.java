...
public class NoArrowSpinner extends TextView {
    ...
    public NoArrowSpinner(Context context) {
        super(context);
        init(context, null);
    }

    public NoArrowSpinner(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public NoArrowSpinner(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                }
        ...
        if (!mHideArrow) {
            Drawable basicDrawable = ContextCompat.getDrawable(context, R.drawable.icon_down_24dp);
