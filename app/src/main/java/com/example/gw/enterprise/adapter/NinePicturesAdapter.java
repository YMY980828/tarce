package com.example.gw.enterprise.adapter;
...
import com.example.gw.enterprise.common.utils.ViewHolderUtil;
import com.example.gw.enterprise.photoPicker.adapter.BaseAblistViewAdapter;
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(url)) {
                    ...
                    DisplayUtil.showFullImage(mContext, list.toArray(new String[list.size()]), position);
